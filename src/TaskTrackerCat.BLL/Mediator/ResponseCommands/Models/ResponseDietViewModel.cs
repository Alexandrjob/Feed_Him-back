namespace TaskTrackerCat.BLL.Mediator.ResponseCommands.Models;

public class ResponseDietViewModel
{
    ...
    {
        if (obj == null || !(obj is ResponseDietViewModel)) return false;

        var other = (ResponseDietViewModel) obj;
